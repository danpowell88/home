...
namespace NetDaemon.Daemon.Tests
{
    ...
    public partial class DaemonHostTestBase<T>: IAsyncLifetime where T : NetDaemonRxApp,   new()
    {
        private readonly NetDaemonHost _defaultDaemonHost;
        protected readonly T DefaultDaemonRxApp;
        ...
        internal DaemonHostTestBase()
        {
            ...
            DefaultDaemonRxApp = new T();
            DefaultDaemonRxApp.Id = "app_rx_id";
            DefaultDaemonRxApp.IsEnabled = true;
            _defaultDaemonHost.InternalRunningAppInstances[DefaultDaemonRxApp.Id!] = DefaultDaemonRxApp;
        ...
        {
            await DefaultDaemonRxApp.StartUpAsync(_defaultDaemonHost).ConfigureAwait(false);
